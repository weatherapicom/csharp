...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ForecastCondition :  IEquatable<ForecastCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForecastCondition" /> class.
        /// </summary>
        /// <param name="text">text.</param>
        /// <param name="icon">icon.</param>
        /// <param name="code">code.</param>
        public ForecastCondition(string text = default(string), string icon = default(string), int? code = default(int?))
        {
            this.Text = text;
            this.Icon = icon;
            this.Code = code;
        ...
        {
            return this.Equals(input as ForecastCondition);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ForecastCondition input)
        {
            if (input == null)
                return false;
