...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AstronomyAstro :  IEquatable<AstronomyAstro>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AstronomyAstro" /> class.
        /// </summary>
        ...
        public AstronomyAstro(string sunrise = default(string), string sunset = default(string), string moonrise = default(string), string moonset = default(string), string moonPhase = default(string), string moonIllumination = default(string))
        {
        ...
        {
            return this.Equals(input as AstronomyAstro);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(AstronomyAstro input)
        {
            if (input == null)
                return false;
