...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CurrentCondition :  IEquatable<CurrentCondition>, IValidatableObject
    {
        /// <summary>
        ...
        public CurrentCondition(string text = default(string), string icon = default(string), int? code = default(int?))
        {
            this.Text = text;
            this.Icon = icon;
            this.Code = code;
        ...
        {
            return this.Equals(input as CurrentCondition);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CurrentCondition input)
        {
            if (input == null)
                return false;
