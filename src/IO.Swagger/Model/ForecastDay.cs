...
namespace IO.Swagger.Model
{
        ...
        public partial class ForecastDay :  IEquatable<ForecastDay>, IValidatableObject
    {
        ...
        public ForecastDay(decimal? maxtempC = default(decimal?), decimal? maxtempF = default(decimal?), decimal? mintempC = default(decimal?), decimal? mintempF = default(decimal?), decimal? avgtempC = default(decimal?), decimal? avgtempF = default(decimal?), decimal? maxwindMph = default(decimal?), decimal? maxwindKph = default(decimal?), int? totalprecipMm = default(int?), int? totalprecipIn = default(int?), int? avgvisKm = default(int?), int? avgvisMiles = default(int?), int? avghumidity = default(int?), int? dailyWillItRain = default(int?), int? dailyChanceOfRain = default(int?), int? dailyWillItSnow = default(int?), int? dailyChanceOfSnow = default(int?), ForecastDayCondition condition = default(ForecastDayCondition), int? uv = default(int?))
        {
